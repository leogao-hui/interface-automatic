...
class TestGenerateSolutions(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        system_variable_three = cls.add_func.get_system_variable_ci(data=body_three)
        system_variable_four = cls.add_func.get_system_variable_ci(data=body_four)
        system_variable_five = cls.add_func.get_system_variable_ci(data=body_five)
        ...
        height_data = {
            ...
            "surveyItem[comment]": "",
            "surveyItem[preConditionItems][0][matchExp]": "(性别=男)&(患者常驻省份=河北省)&(民族=汉族)&(患者常驻城市=唐山市)",
        ...
        job_data = {
            ...
            "surveyItem[preConditionItems][0][matchExp]": "(身高>100)&(年龄>10)",
            "surveyItem[preConditionItems][0][description]": "显示条件",
            "surveyItem[preConditionItems][0][comment]": "1111",
        ...
        evaluate_version_one_data = {
            ...
            'items[7][itemId]': system_variable_one,
            'items[7][itemType]': 'direct_variable',
            'items[8][itemId]': system_variable_two,
            'items[8][itemType]': 'direct_variable',
            'items[9][itemId]': system_variable_three,
            'items[9][itemType]': 'direct_variable',
            'items[10][itemId]': system_variable_four,
            'items[10][itemType]': 'direct_variable',
            'items[11][itemId]': system_variable_five,
            'items[11][itemType]': 'direct_variable',
        }
        ...
        cls.realItem_eight = direct_variable_data[3]
        cls.realItem_nine = direct_variable_data[4]
        cls.realItem_ten = direct_variable_data[5]
        cls.realItem_eleven = direct_variable_data[6]
        cls.realItem_twelve = direct_variable_data[14]
        ...
        combo_one = {
            ...
            'items[8][itemType]': 'direct_variable',
            'items[9][itemId]': cls.realItem_ten,
            'items[9][itemType]': 'direct_variable',
            'items[10][itemId]': cls.realItem_eleven,
            'items[10][itemType]': 'direct_variable',
            'items[11][itemId]': cls.realItem_twelve,
            'items[11][itemType]': 'direct_variable',
        }
        ...
        cls.add_func.generate_report(params)
