...
class TestAddPlanToRelease(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.url = '%s/api/rule/evaluateItem' % ci_url
        ...
        solution_group_available_evaluate_data_two = {
            ...
            'name': '测试评估名2',
            'content': '{"info":{"id":1,"name":"信息结构1","type":"info"},"content":{"评估显示名":"评估显示名1","评估条件":"*","评估意义":"1111","匹配结果项列表":{"info":{"id":-2,"name":"评估匹配结构","type":"evl_match"},"content":[{"适用条件":{"info":{"id":-2,"name":"表达式结构","type":"condition"},'
                       '"content":[{"表达式":"(身高>50)&(职业$1(休养或退休))&(计算变量二=20)&(量表变量二=30)","情况说明":"11","备注":"1"}]},"匹配用结果项名":"身高","解读":{"info":{"id":2,"name":"信息结构2","type":"info"},"content":{"定义":"1","产生原因":"1","微观影响说明":"1"}},"分组":"1","备注":"1"}]},"用户可见结果项":{"info":{"id":-3,"name":"用户可见结果项","type":"visual"},"content":[{"适用条件表达式":"","用户可见的结果项名":"","分组":"","备注":""}]}}}',
            'isSolutionCanUse': 'no',
            'comment': '111'
        }
        ...
        solution_group_available_evaluate_data_three = {
            ...
            'name': '测试评估名3',
            'content': '{"info":{"id":1,"name":"信息结构1","type":"info"},"content":{"评估显示名":"评估显示名1","评估条件":"*","评估意义":"1111","匹配结果项列表":{"info":{"id":-2,"name":"评估匹配结构","type":"evl_match"},"content":[{"适用条件":{"info":{"id":-2,"name":"表达式结构","type":"condition"},'
                       '"content":[{"表达式":"(身高>50)&(职业$1(专业技术人员))&(计算变量二=20)&(量表变量二=30)&(身高=匹配用结果项名1)","情况说明":"11","备注":"1"}]},"匹配用结果项名":"匹配用结果项名1","解读":{"info":{"id":2,"name":"信息结构2","type":"info"},"content":{"定义":"1","产生原因":"1","微观影响说明":"1"}},"分组":"1","备注":"1"}]},"用户可见结果项":{"info":{"id":-3,"name":"用户可见结果项","type":"visual"},"content":[{"适用条件表达式":"","用户可见的结果项名":"","分组":"","备注":""}]}}}',
            'isSolutionCanUse': 'yes',
            'comment': '111'
        }
        ...
        project_group_specific_calculation_variable_three_data = {
            'name': '方案组专用计算变量三',
            'optionalValues[0][matchExpression]': '(方案组专用计算变量二=40)&(量表变量二=40)&(身高=匹配用结果项名1)',
            'optionalValues[0][content]': '1',
            'optionalValues[0][priority]': '1',
            'optionalValues[0][comment]': '111',
            'module': 'mentality_module',
        ...
        project_group_specific_calculation_variable_four_data = {
            'name': '方案组专用计算变量四',
            'optionalValues[0][matchExpression]': '(方案组专用计算变量三=40)&(量表变量二=40)&(身高=匹配用结果项名1)',
            'optionalValues[0][content]': '1',
            'optionalValues[0][priority]': '1',
            'optionalValues[0][comment]': '111',
            'module': 'mentality_module',
        ...
        evaluate_version_one_data = {
            ...
            'items[13][itemId]': cls.evaluate_two,
            'items[13][itemType]': 'evaluate_item',
            'items[14][itemId]': cls.evaluate_three,
